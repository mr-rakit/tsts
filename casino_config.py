...
tickets = '5194129308:AAHz6MJu2M5vYzyvnvL__075ZuCo0h4NIh8' # TOKEN Бота воркера
bot = telebot.TeleBot('5226140439:AAE2MDans_OY1zbWi_k8yk3VwCaOBT_8GHs') # TOKEN Бота казино

admin = 5148689161 # ID Админа
support_id = 896786689 # ID Саппорта
channel_id = -1001620773561 # ID Канала с вылатами
support = 'OneWinSupportOfficial' # Username Сапорта
